                ...
                <div className="mt-8">
                  ...
                  <div className="flex gap-4">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className={`card-dark px-4 py-2 rounded-lg text-sm ${socialLinks.facebook ? 'text-gray-400 hover:text-[#c9a84c]' : 'text-gray-500 cursor-not-allowed opacity-60'}`}
                    >
                      Facebook
                    </a>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className={`card-dark px-4 py-2 rounded-lg text-sm ${socialLinks.instagram ? 'text-gray-400 hover:text-[#c9a84c]' : 'text-gray-500 cursor-not-allowed opacity-60'}`}
                    >
                      Instagram
                    </a>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className={`card-dark px-4 py-2 rounded-lg text-sm ${socialLinks.tiktok ? 'text-gray-400 hover:text-[#c9a84c]' : 'text-gray-500 cursor-not-allowed opacity-60'}`}
                    >
                      TikTok
                    </a>
                  </div>
